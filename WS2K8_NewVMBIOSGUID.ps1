<#
Get-WmiObject -Namespace root\virtualization\v2 -class Msvm_VirtualSystemSettingData -Filter "ElementName LIKE 'VADBELV%'"| select VirtualSystemIdentifier,ConfigurationID,elementname, BIOSSerialNumber,BIOSGUID
#>
